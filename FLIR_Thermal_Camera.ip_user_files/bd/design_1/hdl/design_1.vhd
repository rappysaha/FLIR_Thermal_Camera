...
architecture STRUCTURE of design_1 is
  ...
  signal B_CONST_dout : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal G_CONST_dout : STD_LOGIC_VECTOR ( 7 downto 0 );
...
B_CONST: component design_1_R_CONST_1
     port map (
      dout(7 downto 0) => B_CONST_dout(7 downto 0)
    );
G_CONST: component design_1_R_CONST_0
     port map (
      dout(7 downto 0) => G_CONST_dout(7 downto 0)
    );
R_CONST: component design_1_xlconstant_0_1
     port map (
      dout(7 downto 0) => blk_mem_gen_0_doutb(7 downto 0)
    );
...
xlconcat_0: component design_1_xlconcat_0_0
     port map (
      ...
      In1(7 downto 0) => G_CONST_dout(7 downto 0),
      In2(7 downto 0) => B_CONST_dout(7 downto 0),
